		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="admin/index1.php"> Le <span>restaurant</span><p class="logo_w3l_agile_caption">de saveurs</p></a></h1>
				</div>
					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4>le restaurant</h4>
									<h3>Sabemos lo que quieres</h3>
										<p>Bienvenido a nuestro restaurante
</p>
				...
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">leer más
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>Beaucoup de saveurs</h4>
									<h3>Pruebalo con amigos y familias</h3>
										<p>Ven y disfruta un momento precioso </p>
									<div class="agileits_w3layouts_more menu__item">
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">leer más</a>
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top2">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>beaucoup de plats</h4>
								<h3>Que esperas</h3>
										<p>Realice su reserva hoy</p>
									<div class="agileits_w3layouts_more menu__item">
											<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">leer más</a>
										</div>
								</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>LE
  <span>RESTAURANT</span></h4>
										<img src="images/1.jpg" alt=" " class="img-responsive">
										<h5>Sabemos lo que quieres</h5>
										<p>Pruebe nuestro menú de comida, servicios increíbles y un personal amable mientras esté aquí..</p>
									</div>
								</div>
							</div>
						</div>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/index1.php"><h2>RESERVA HOY!
</h2></a>
</div>
	...
	<div class="banner-bottom">
		<div class="container">	
			<div class="agileits_banner_bottom">
				<h3><span>Experimenta una buena estadía</span> Encuentra nuestra acogedora bienvenida
</h3>
			</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">VARIEDAD DE MESAS
</h4>
					...
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">GRANDES PLATOS
</h4>
							<span class="cbp-ig-category">AMANECER</span>
						</div>
					</li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">Acerca de nuestro LE RESTAURANT
</h3> 
						   <p class="about-para-w3ls"> El restaurante independiente más antiguo. Uno de los favoritos de la zona durante más de 83 años. Con nuestras famosas salsas de espaguetis DeAngelis y nuestra famosa pizza Upside Down. Platos italianos caseros y deliciosos con marisco, bistec y pasta. Menú de bar completo y selección de sándwiches. Menú completo durante todo el día y hasta bien entrada la noche. 
</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
										    <h4>Te encantarán todas los platos que tenemos
!</h4>
											<p>que esperas disfruta de la comida con nosotros. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
.</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>Mesas diponibles a gran vista
</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>Sin embargo, en ciertas circunstancias y el deber o la obligación se producen con frecuencia que los placeres tienen a sus funciones,
.</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>24 horas de servicio
</p>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p> Bienvenido a LE RESTAURANT DE SAVEURS 
.</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>Estamos para ser de  tus estadia la 
								mejor porque sabemos que te esuferzas trabajando, te ofrecemos lo mejor .</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<span>Chef</span>
							<p>Que esperas para disfrutar los platos mas deliciosos de tu vida.</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
...
<!-- //gallery -->
	 <!-- rooms & rates -->
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">Secciones de nuestro restaurante
</h3>
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h3><span>$</span>320</h3>						
								<a href="admin/index1.php" >	Reservar ahora
</a>
							</div>
						</div>
					</div>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>es fascinantes y divertido pase momentos agradables de mis vaciones en este restaurante. </p>
								<h5>Julia Rose</h5>
								<p>Alemania</p>
							</div>
							<div class="clearfix"> </div>
...
:</label>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Teléfono :</strong>+51 956 286 965</p>
			<p class="contact-agile1"><strong>Email :</strong>lerestaurant@corporation.com</p>
			<p class="contact-agile1"><strong>Direccion :</strong> Arequipa</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2018  <a href="index.php">LERESTAURANT</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
